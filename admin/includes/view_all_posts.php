                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="update_post_category_id" id="update_post_category_id"
                                    class="form-control">
                                    <?php
...
if (isset($_POST['update_post'])) {
    ...
    $update_post_content = $_POST['update_post_content'];
    ...
    $update_query .= "post_cat_id= {$update_post_category_id}, ";
    $update_query .= "post_title = '{$update_post_title}', ";
    $update_query .= "post_author = '{$update_post_author}', ";
    $update_query .= "post_image = '{$post_image}', ";
    $update_query .= "post_content='{$update_post_content}', ";
    $update_query .= "post_tag= '{$update_post_tags}', ";
    $update_query .= "post_status= '{$update_post_status}' ";
    $update_query .= "WHERE posts_id = {$posts_id}";

    $update_posts = mysqli_query($conn, $update_query);
